...
export default function LoginMessage() {
  ...
  return (
    <div className="flex flex-col gap-3">
      <h2 className="text-xl md:text-2xl lg:text-3xl font-semibold tracking-tight text-white">
        {isFirstWorkout
          ? "Start building your first streak."
          : "Stay consistent. Track your progress."}
      </h2>

      <p className="max-w-lg text-[13px] md:text-sm leading-relaxed text-slate-400">
        {isFirstWorkout
