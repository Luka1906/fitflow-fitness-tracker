      ...
      <div className="relative mt-10">
        ...
        <div className="flex flex-wrap gap-3">
          {user.selectedGoals.map((goal) => (
            <span
              key={goal.id}
              className="rounded-full border border-accent-dark/15 bg-accent-dark/10 px-4 py-2 text-sm font-medium text-accent-dark hover:bg-accent-dark/15 transition"
            >
              {goal.name}
            </span>
          ))}
