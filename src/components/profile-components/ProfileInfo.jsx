...
export default function ProfileInfo({ user, goals, water, workouts }) {
  ...
  // get users initial function

  const getUsersInitial = (user) => {
    const firstLeterName = user.first_name[0];
    const firstLetterLastName = user.last_name[0];

    return firstLeterName + firstLetterLastName;
  };
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-6">
            <div className="relative w-fit">
              {avatarPreview ? (
                ...
                <div className="w-40 h-40 sm:w-44 sm:h-44 rounded-3xl border border-white/15 shadow-2xl flex items-center justify-center text-6xl tracking-widest font-medium text-text-primary-headings">
                  {getUsersInitial(user)}
                </div>
              )}
