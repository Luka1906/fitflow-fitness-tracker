    ...
    <section className="px-6 py-28 ">
      ...
      <div className="mx-auto  max-w-5xl  mt-10 flex  flex-col items-center justify-center gap-6 rounded-2xl border border-slate-700 bg-slate-900/50 p-6 md:flex-row">
        <div className="flex w-full items-center gap-4 md:w-auto">
          <div className="flex h-14 w-14 items-center justify-center rounded-full bg-accent-dark/10 text-accent-dark">
      ...
      <div className="mt-6 flex w-fit mx-auto rounded-full border border-slate-700 px-4 py-2 text-sm text-slate-400">
